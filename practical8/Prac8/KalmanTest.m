    ...
    if t==frame_ini
       ...
       %///////// TO BE COMPLETED (STEP 4) \\\\\\\\\\\%
        ...
        if NumCandidates>0
            ...
            %Select as measurement the closest blob to the filter's prediction and put it in a vector in the suitable form 
